...
(
    ...
    `package_seq` int NOT NULL COMMENT '패치키 순번',
    `user_id` varchar(20) NOT NULL COMMENT '사용자 ID',
    `status` varchar(10) NOT NULL COMMENT '상태',
    `remaining_count` int DEFAULT NULL DEFAULT '0' COMMENT '잔여 이용권 수, NULL인 경우 무제한',
...
(
    ...
    `started_at` timestamp NOT NULL COMMENT '시작 일시',
    `ended_at` timestamp DEFAULT NULL COMMENT '종료 일시',
